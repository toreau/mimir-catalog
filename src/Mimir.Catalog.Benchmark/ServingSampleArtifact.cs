...
/// <summary>
/// Deterministic JSONL writer for serving raw timed samples. UTF-8 no BOM,
/// compact fixed property order, LF line terminator, no trailing non-JSON.
/// Create-new only; never overwrites. Zero samples produce a valid empty file.
/// </summary>
public static class ServingSampleArtifact
{
    public static void WriteCreateNew(string path, IReadOnlyList<ServingTimedSample> samples)
    {
    ...
    private static byte[] SerializeLine(ServingTimedSample sample)
    {
